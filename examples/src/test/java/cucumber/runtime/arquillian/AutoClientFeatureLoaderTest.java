...
public class AutoClientFeatureLoaderTest {
     ...
     * suffix) { if (!path.equals("jira2/PROJECT-001") ||
     * !suffix.equals(".feature")) { return emptyList(); } final Resource resource =
     * new Resource() {
     *
     * @Override public String getPath() { return "jira2/PROJECT-001.feature"; }
     *
